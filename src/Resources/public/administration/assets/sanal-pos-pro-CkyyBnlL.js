...
<sw-page class="sanalpospro-webhook-log-list">
    ...
    `,mounted(){let e=106;try{const a=localStorage.getItem("paythor-merchant-app");a&&!isNaN(parseInt(a))&&(e=parseInt(a))}catch{}this._resolvedAppId=e,this.loadPayThorApp()},beforeDestroy(){this.cleanupPayThorApp()},methods:{loadPayThorApp(){if(this.cleanupPayThorApp(),this._createdRoot=!document.getElementById("root"),this._createdRoot){const t=document.createElement("div");t.id="root",t.style.cssText="position:fixed;top:50px;left:220px;right:0;bottom:0;z-index:10;background:#fff;overflow:auto;",document.body.appendChild(t)}const e=this._resolvedAppId||106,a=`https://cdn.paythor.com/1/${e}/10.0.4`;window.xfvv="shopware",window.target_url=window.location.origin+"/sanalpospro/iapi/index",window.store_url=window.location.origin,window.app_id=e,window.platform="shopware",window.program_id=1,window.style_url=`${a}/index.css`,window.generalSettings={order_status:{default_value:"process",options:{process:"Processing"}},currency_convert:{default_value:"no",options:{yes:"Yes",no:"No"}},showInstallmentsTabs:{default_value:"no",options:{yes:"Yes",no:"No"}},paymentPageTheme:{default_value:"modern",options:{classic:"Classic",modern:"Modern"}}};try{const t="paythor-connect-app-id",s=String(e);localStorage.getItem(t)!==s&&(["etc-token","etc-user-level","etc-is-impersonating","etc-original-admin-token","etc-impersonate-token"].forEach(r=>localStorage.removeItem(r)),sessionStorage.clear(),localStorage.setItem(t,s))}catch{console.warn("[SanalPosPro] localStorage access denied")}const l=document.createElement("link");l.id="paythor-style",l.rel="stylesheet",l.href=window.style_url,document.head.appendChild(l);const o=document.createElement("script");o.id="paythor-script",o.type="module",o.src=`${a}/index.js?v=`+Date.now(),o.onerror=()=>console.error("[SanalPosPro] CDN script failed to load:",o.src),document.body.appendChild(o)},cleanupPayThorApp(){const e=document.getElementById("paythor-script");e&&e.remove();const a=document.getElementById("paythor-style");if(a&&a.remove(),this._createdRoot){const l=document.getElementById("root");l&&l.remove(),this._createdRoot=!1}}}});Shopware.Module.register("sanalpospro-connect",{type:"plugin",name:"sanalpospro-connect",title:"SanalPos Pro",description:"PayThor React CDN Application",color:"#1abc9c",icon:"regular-credit-card",routes:{index:{component:"sanalpospro-connect-index",path:"index"}},navigation:[{id:"sanalpospro-connect",label:"SanalPos Pro",color:"#1abc9c",icon:"regular-credit-card",parent:"sw-extension",position:10},{id:"sanalpospro-connect-index",label:"Account & Management",color:"#1abc9c",path:"sanalpospro.connect.index",icon:"regular-credit-card",parent:"sanalpospro-connect",position:10}]});(function(){const l=window.fetch.bind(window);window.fetch=function(o,t){const s=typeof o=="string"?o:o&&o.url||"";if(!(s.includes("paythor.com")||s.includes("sanalpospro.com")))return l(o,t);t=t?Object.assign({},t):{};const i=t.headers||{},p=i instanceof Headers?i:new Headers(i);if(p.set("etc-app-id",String(106)),t.headers=p,t.body&&typeof t.body=="string")try{const n=JSON.parse(t.body);n.auth_query&&n.auth_query.app_id!==106&&(n.auth_query.app_id=106,t.body=JSON.stringify(n))}catch{}return l(o,t)}})();
//# sourceMappingURL=sanal-pos-pro-CkyyBnlL.js.map
